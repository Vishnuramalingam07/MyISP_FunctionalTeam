...
# Generated by GitHub Copilot – Supabase integration
try:
    ...
    print(f"⚠️  Supabase disabled (missing .env or package not installed): {_sb_err}")
...
def download_daily_status_report():
    ...
    report_file = os.path.join(os.getcwd(), 'Main_Release_Daily_Status_Report', 'Daily_Status_Dashboard.html')
...
def run_daily_status_script():
    ...
    try:
        ...
        report_file = os.path.join(os.getcwd(), 'Main_Release_Daily_Status_Report',
                                   'Daily_Status_Dashboard.html')
        if os.path.exists(report_file):
            print(f"Report generated successfully: {report_file}")
            daily_status_report_status['last_generated'] = 'Main_Release_Daily_Status_Report/Daily_Status_Dashboard.html'
